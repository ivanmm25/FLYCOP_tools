...
def SelectConsortiumArchitecture(sucr1, frc2, nh4_Ec, nh4_KT, FVApCA, FVAfru, FVAGerNar, FVANar, 
  ...
  for i in range(repeat):
        ...
        n_metabolites = 7  # 7 metabolites to track (manual adjustment by user). In this case: sucr 6gernar fru nar nh4 pi o2
        ...
        subprocess.run(['../../Scripts/plot_biomassX2_vs_4mediaItem_generalized.sh template2 sucr 6gernar fru nar nh4 pi o2 '+str(maxCycles)+' '+baseConfig+' blue black darkmagenta yellow orange aquamarine '+strains_string], shell=True)
